...
\item[El] Elevation.
\item[FITS] FITS (Flexible Image Transport System) is a digital file format.   used to store, transmit, and manipulate scientific and other images. FITS
  commonly used in astronomy.
\item[H5parm] LOFAR convention for storing calibration solutions in HDF5, also used for other radio telescopes.
