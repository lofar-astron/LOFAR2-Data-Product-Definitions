...
\input common_tables/groups_sys_log
...
\input common_tables/coordinates_group_table
...
\input common_tables/coordinates_coord_direction

\subsubsection{Spectral coordinate}
\label{sec:coord-spectral}

\input common_tables/coordinates_coord_spectral

\subsubsection{Polarization coordinate}
\label{sec:coord-polarization}

\input common_tables/coordinates_coord_polarization
...
\input common_tables/table_processing_history
