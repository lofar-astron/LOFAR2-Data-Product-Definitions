...
\comment{Copied from USG version. Needs to be changed to the DDD structure.}
...
\comment{Missing OBSERVATION_NOF_SUBBANDS. Total number of subbands. In root group, can be specific for BF format or shared with others}
